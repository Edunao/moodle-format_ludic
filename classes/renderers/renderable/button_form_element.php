...
class format_ludic_button_form_element extends format_ludic_form_element {
    ...
    public function __construct(\format_ludic\form_element $element) {
        ...
        $this->action  = isset($element->attributes['action']) ? $element->attributes['action'] : false;
        $this->itemid = isset($element->attributes['itemid']) ? $element->attributes['itemid'] : false;
    }
